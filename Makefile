...
windows_encoder: c_src/encoder.c
  cl /LD /I .\\deps\\membrane_common_c\\include /I $(ERL_INCLUDE_PATH_WINDOWS) /I $(OPUS_INCLUDE_PATH_WINDOWS) c_src/encoder.c c_src/util.c opus.lib celt.lib silk_common.lib silk_float.lib /link /LIBPATH:$(OPUS_LIB_PATH_WINDOWS) /OUT:membrane_element_opus_encoder.dll

windows_decoder: c_src/decoder.c
  cl /LD /I .\\deps\\membrane_common_c\\include /I $(ERL_INCLUDE_PATH_WINDOWS) /I $(OPUS_INCLUDE_PATH_WINDOWS) c_src/decoder.c c_src/util.c opus.lib celt.lib silk_common.lib silk_float.lib /link /LIBPATH:$(OPUS_LIB_PATH_WINDOWS) /OUT:membrane_element_opus_decoder.dll
